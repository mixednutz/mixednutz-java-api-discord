...
import net.mixednutz.api.discord.model.MessageElement;
...
public class MessageAdapter extends BaseDiscordAdapter implements PostClient<MessageForm> {
	...
	@Override
	public MessageElement postToTimeline(MessageForm post) {
		return applyWithApi((api)->{	
